...
async def register_handlers(dp: Dispatcher, bot_token):
    ...
    async def send_full_message(message: types.Message, state: FSMContext):
        ...
        await message.answer(
            "<b>Вас приветствует магазин - Читай-Город \n\nНаши контакты: </b>\nch-g.biz (c VPN)\nch-g.ton (c Tonbrouser)\nchitjbol7lv65qnfbmhpl4ydz45w7qcqxk4f33z7jtqwn5hlhkgsjvyd.onion (c Torbrouser)\nt.me/ch_g_bot (Телеграмм)\n\nУдачных покупок!\n"
            "➖➖➖\n"
            f"Привет, <b>{user_username}</b>\n"
            "Ваш баланс: <b>💰0 руб.</b>\n"
            "Всего покупок: 0шт.\n"
